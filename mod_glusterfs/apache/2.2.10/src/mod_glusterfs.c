...
command_rec mod_glfs_cmds[] =
{
	...
	/* mod_dir cmds */
	AP_INIT_ITERATE("DirectoryIndex", cmd_add_index, NULL, DIR_CMD_PERMS,
			"a list of file names"),

	AP_INIT_FLAG("DirectorySlash", cmd_configure_slash, NULL, DIR_CMD_PERMS,
		     "On or Off"),

        /* autoindex cmds */
        AP_INIT_ITERATE2("AddIcon", cmd_add_icon, BY_PATH, DIR_CMD_PERMS,
                         "an icon URL followed by one or more filenames"),
        AP_INIT_ITERATE2("AddIconByType", cmd_add_icon, BY_TYPE, DIR_CMD_PERMS,
                         "an icon URL followed by one or more MIME types"),
        AP_INIT_ITERATE2("AddIconByEncoding", cmd_add_icon, BY_ENCODING, DIR_CMD_PERMS,
                         "an icon URL followed by one or more content encodings"),
        AP_INIT_ITERATE2("AddAlt", cmd_add_alt, BY_PATH, DIR_CMD_PERMS,
                         "alternate descriptive text followed by one or more "
                         "filenames"),
        AP_INIT_ITERATE2("AddAltByType", cmd_add_alt, BY_TYPE, DIR_CMD_PERMS,
                         "alternate descriptive text followed by one or more MIME "
                         "types"),
        AP_INIT_ITERATE2("AddAltByEncoding", cmd_add_alt, BY_ENCODING, DIR_CMD_PERMS,
                         "alternate descriptive text followed by one or more "
                         "content encodings"),
        AP_INIT_TAKE_ARGV("IndexOptions", cmd_add_opts, NULL, DIR_CMD_PERMS,
                          "one or more index options [+|-][]"),
        AP_INIT_TAKE2("IndexOrderDefault", cmd_set_default_order, NULL, DIR_CMD_PERMS,
                      "{Ascending,Descending} {Name,Size,Description,Date}"),
        AP_INIT_ITERATE("IndexIgnore", cmd_add_ignore, NULL, DIR_CMD_PERMS,
                        "one or more file extensions"),
        AP_INIT_ITERATE2("AddDescription", cmd_add_desc, BY_PATH, DIR_CMD_PERMS,
                         "Descriptive text followed by one or more filenames"),
        AP_INIT_TAKE1("HeaderName", cmd_add_header, NULL, DIR_CMD_PERMS,
                      "a filename"),
        AP_INIT_TAKE1("ReadmeName", cmd_add_readme, NULL, DIR_CMD_PERMS,
                      "a filename"),
