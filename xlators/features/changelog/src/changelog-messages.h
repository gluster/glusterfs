...
GLFS_MSGID(
    ...
    CHANGELOG_MSG_DEQUEUING_BARRIER_FOPS, CHANGELOG_MSG_XATTR_CREATE_FAILED,
...
#define CHANGELOG_MSG_NOT_FOUND_STR "changelog not found"
...
#define CHANGELOG_MSG_XATTR_CREATE_FAILED_STR "Unable to create xattr"
