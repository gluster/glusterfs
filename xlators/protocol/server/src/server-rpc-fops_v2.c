...
static rpcsvc_actor_t glusterfs4_0_fop_actors[] = {
    ...
    [GFS3_OP_FALLOCATE] = {"FALLOCATE", server4_0_fallocate, NULL,
                           GFS3_OP_FALLOCATE, DRC_NA, 0},
    [GFS3_OP_DISCARD] = {"DISCARD", server4_0_discard, NULL, GFS3_OP_DISCARD,
                         DRC_NA, 0},
    [GFS3_OP_ZEROFILL] = {"ZEROFILL", server4_0_zerofill, NULL,
                          GFS3_OP_ZEROFILL, DRC_NA, 0},
    [GFS3_OP_IPC] = {"IPC", server4_0_ipc, NULL, GFS3_OP_IPC, DRC_NA, 0},
    [GFS3_OP_SEEK] = {"SEEK", server4_0_seek, NULL, GFS3_OP_SEEK, DRC_NA, 0},
    [GFS3_OP_LEASE] = {"LEASE", server4_0_lease, NULL, GFS3_OP_LEASE, DRC_NA,
                       0},
    [GFS3_OP_GETACTIVELK] = {"GETACTIVELK", server4_0_getactivelk, NULL,
                             GFS3_OP_GETACTIVELK, DRC_NA, 0},
    [GFS3_OP_SETACTIVELK] = {"SETACTIVELK", server4_0_setactivelk, NULL,
                             GFS3_OP_SETACTIVELK, DRC_NA, 0},
    [GFS3_OP_COMPOUND] = {"COMPOUND", server4_0_compound, NULL,
                          GFS3_OP_COMPOUND, DRC_NA, 0},
    [GFS3_OP_ICREATE] = {"ICREATE", server4_0_icreate, NULL, GFS3_OP_ICREATE,
                         DRC_NA, 0},
    [GFS3_OP_NAMELINK] = {"NAMELINK", server4_0_namelink, NULL,
                          GFS3_OP_NAMELINK, DRC_NA, 0},
    [GFS3_OP_COPY_FILE_RANGE] = {"COPY-FILE-RANGE", server4_0_copy_file_range,
                                 NULL, GFS3_OP_COPY_FILE_RANGE, DRC_NA, 0},
};
