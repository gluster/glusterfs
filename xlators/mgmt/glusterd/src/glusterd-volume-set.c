...
struct volopt_map_entry glusterd_volopt_map[] = {
        ...
        { .key         = "features.encryption",
          ...
          .description = "enable/disable client-side encryption for "
                         "the volume.",
          .flags       = VOLOPT_FLAGCLIENT_OPT | VOLOPT_FLAGXLATOR_OPT
        },
