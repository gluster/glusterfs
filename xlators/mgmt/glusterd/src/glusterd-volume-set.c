...
struct volopt_map_entry glusterd_volopt_map[] = {
    ...
    {.key = "features.cloudsync-product-id",
     ...
     .flags = VOLOPT_FLAG_CLIENT_OPT},
    {.key = "features.tier",
     .voltype = "features/tier",
     .value = "off",
     .option = "!features",
     .op_version = GD_OP_VERSION_7_0},
    {.key = "features.tier-storetype",
     .voltype = "features/tier",
     .op_version = GD_OP_VERSION_7_0},
    {.key = "features.tier-cold-mountpoint",
     .voltype = "features/tier",
     .op_version = GD_OP_VERSION_7_0},
    {.key = "features.tier-remote-read",
     .voltype = "features/tier",
     .op_version = GD_OP_VERSION_7_0},
    {.key = "features.tier-stub-size",
     .voltype = "storage/posix",
     .op_version = GD_OP_VERSION_7_0},
    {.key = "features.tier-plugin-migrate-thread",
     .voltype = "features/tier",
     .op_version = GD_OP_VERSION_7_0},
    {.key = "features.tier-threshold-block-count",
     .voltype = "features/tier",
     .op_version = GD_OP_VERSION_7_0},
    {.key = NULL},
};
