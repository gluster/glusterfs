...
GLFS_MSGID(AFR, AFR_MSG_QUORUM_FAIL, AFR_MSG_QUORUM_MET,
           ...
           AFR_MSG_INVALID_SUBVOL, AFR_MSG_SELF_HEAL_INFO,
           AFR_MSG_READ_SUBVOL_ERROR, AFR_MSG_DICT_GET_FAILED,
           AFR_MSG_INFO_COMMON, AFR_MSG_SPLIT_BRAIN_CHOICE_ERROR,
           AFR_MSG_LOCAL_CHILD, AFR_MSG_INVALID_DATA, AFR_MSG_INVALID_ARG,
           ...
           AFR_MSG_THIN_ARB, AFR_MSG_THIN_ARB_XATTROP_FAILED,
           AFR_MSG_THIN_ARB_LOC_POP_FAILED, AFR_MSG_GET_PEND_VAL,
           AFR_MSG_THIN_ARB_SKIP_SHD, AFR_MSG_UNKNOWN_SET, AFR_MSG_NO_XL_ID,
           AFR_MSG_SELF_HEAL_INFO_START, AFR_MSG_SELF_HEAL_INFO_FINISH,
           AFR_MSG_INCRE_COUNT, AFR_MSG_ADD_TO_OUTPUT_FAILED,
           AFR_MSG_SET_TIME_FAILED, AFR_MSG_GFID_MISMATCH_DETECTED,
           AFR_MSG_GFID_HEAL_MSG, AFR_MSG_THIN_ARB_LOOKUP_FAILED,
           AFR_MSG_DICT_CREATE_FAILED, AFR_MSG_NO_MAJORITY_TO_RESOLVE,
           AFR_MSG_TYPE_MISMATCH, AFR_MSG_SIZE_POLICY_NOT_APPLICABLE,
           AFR_MSG_NO_CHILD_SELECTED, AFR_MSG_INVALID_CHILD,
           AFR_MSG_RESOLVE_CONFLICTING_DATA, SERROR_GETTING_SRC_BRICK,
           SNO_DIFF_IN_MTIME, SNO_BIGGER_FILE, SALL_BRICKS_UP_TO_RESOLVE,
           AFR_MSG_UNLOCK_FAILED, AFR_MSG_POST_OP_FAILED,
           AFR_MSG_TA_FRAME_CREATE_FAILED, AFR_MSG_SET_KEY_XATTROP_FAILED,
           AFR_MSG_BLOCKING_ENTRYLKS_FAILED, AFR_MSG_FOP_FAILED,
           AFR_MSG_CLEAN_UP_FAILED, AFR_MSG_UNABLE_TO_FETCH,
           AFR_MSG_XATTR_SET_FAILED, AFR_MSG_SPLIT_BRAIN_REPLICA,
           AFR_MSG_INODE_CTX_FAILED, AFR_MSG_LOOKUP_FAILED,
           AFR_MSG_ALL_SUBVOLS_DOWN, AFR_MSG_RELEASE_LOCK_FAILED,
           AFR_MSG_CLEAR_TIME_SPLIT_BRAIN, AFR_MSG_READ_FAILED,
           AFR_MSG_LAUNCH_FAILED, AFR_MSG_READ_SUBVOL_NOT_UP,
           AFR_MSG_LK_HEAL_DOM, AFR_MSG_NEW_BRICK,
           AFR_MSG_SPLIT_BRAIN_SET_FAILED, AFR_MSG_SPLIT_BRAIN_DETERMINE_FAILED,
           AFR_MSG_HEALER_SPAWN_FAILED, AFR_MSG_ADD_CRAWL_EVENT_FAILED,
           AFR_MSG_NULL_DEREF, AFR_MSG_SET_PEND_XATTR, AFR_MSG_INTERNAL_ATTR);
