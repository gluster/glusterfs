...
void
gf_buf_test_string_sprintf(void)
{
    char *p = "oops";
    ...
    gf_buf_decl_string(buf0);
    gf_buf_decl_init_string(buf1, "test");
    gf_buf_decl_init_string(buf2, "abcd0123");
    ...
    gf_buf_assign_string(&buf2, "longlonglonglonglonglonglonglonglong");
    gf_buf_sprintf(&buf2, "x = %d y = 0x%x p = %s", x, y, p);
    gf_buf_assert_string(
        &buf2, gf_heap_allocated("longlonglonglonglonglonglonglonglong"),
