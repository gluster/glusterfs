...
int32_t
unix_recieve (struct transport *this,
	     char *buf, 
	     int32_t len)
{
...
int32_t
unix_readv (struct transport *this,
...
int32_t 
unix_disconnect (transport_t *this)
{
  unix_private_t *priv = this->private;
  int32_t ret= 0;
  char need_unref = 0;
