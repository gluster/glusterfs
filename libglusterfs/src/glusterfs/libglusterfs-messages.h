...
GLFS_MSGID(
    ...
    LG_MSG_PIPE_CREATE_FAILED, LG_MSG_REGISTER_PIPE_FAILED,
    LG_MSG_POLL_IGNORE_MULTIPLE_THREADS, LG_MSG_INDEX_NOT_FOUND,
    LG_MSG_EPOLL_FD_CREATE_FAILED, LG_MSG_SLOT_NOT_FOUND, LG_MSG_STALE_FD_FOUND,
    LG_MSG_GENERATION_MISMATCH, LG_MSG_PTHREAD_KEY_CREATE_FAILED,
    LG_MSG_TRANSLATOR_INIT_FAILED, LG_MSG_UUID_BUF_INIT_FAILED,
    LG_MSG_LKOWNER_BUF_INIT_FAILED, LG_MSG_SYNCTASK_INIT_FAILED,
    LG_MSG_SYNCOPCTX_INIT_FAILED, LG_MSG_GLOBAL_INIT_FAILED,
    LG_MSG_PTHREAD_FAILED, LG_MSG_DIR_IS_SYMLINK,
    ...
    LG_MSG_IO_CALL_FAILED, LG_MSG_IO_THREAD_BAD_PRIORITY, LG_MSG_IO_CBK_SLOW,
    LG_MSG_IO_THREAD_NO_CPU, LG_MSG_IO_THREAD_NAME_INVALID, LG_MSG_IO_NO_ENGINE,
