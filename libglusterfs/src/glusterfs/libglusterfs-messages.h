...
GLFS_MSGID(
    ...
    LG_MSG_DUPLICATE_ENTRY, LG_MSG_THREAD_NAME_TOO_LONG,
    LG_MSG_SET_THREAD_FAILED, LG_MSG_THREAD_CREATE_FAILED,
    LG_MSG_FILE_DELETE_FAILED, LG_MSG_WRONG_VALUE, LG_MSG_PATH_OPEN_FAILED,
    LG_MSG_DISPATCH_HANDLER_FAILED, LG_MSG_READ_FILE_FAILED,
    LG_MSG_ENTRIES_NOT_PROVIDED, LG_MSG_ENTRIES_PROVIDED,
    LG_MSG_UNKNOWN_OPTION_TYPE, LG_MSG_OPTION_DEPRECATED, LG_MSG_INVALID_INIT,
    LG_MSG_OBJECT_NULL, LG_MSG_GRAPH_NOT_SET, LG_MSG_FILENAME_NOT_SPECIFIED,
    LG_MSG_STRUCT_MISS, LG_MSG_METHOD_MISS, LG_MSG_INPUT_DATA_NULL,
    LG_MSG_OPEN_LOGFILE_FAILED);
